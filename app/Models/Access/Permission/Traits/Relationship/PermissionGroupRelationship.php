...
trait PermissionGroupRelationship
{
    ...
    {
        return $this->hasMany(config('access.group'), 'parent_id', 'group_id')->orderBy('sort_order', 'asc');
    }
    ...
    {
        return $this->hasMany(config('access.permission'), 'group_id')->orderBy('sort_order', 'asc');
    }
}